  ...
  render() {
    ...
    return (
      <div className="github-wrapper github-user">
        ...
        <a className="github-button" href={"https://github.com/" + this.state.user.login}>
          <MarkGithubIcon className="github-button-icon" />
          <span className="github-button-text">Follow @{this.state.user.login}</span>
        </a>
