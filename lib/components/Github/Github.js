      ...
      child = (
        <div className={tooltipProps.parentClass}>
          <Tooltip
            ...
            onClick={this.handleTooltipWindowActivate.bind(this)}
            onMouseEnter={this.handleTooltipWindowActivate.bind(this)}
            onMouseLeave={this.handleTooltipMouseLeave.bind(this)}
          ...
          <button
            ...
            onBlur={this.handleTooltipClose.bind(this)}
            onClick={this.handleTooltipOpen.bind(this)}
            onMouseEnter={this.handleTooltipMouseEnter.bind(this)}
            onMouseLeave={this.handleTooltipMouseLeave.bind(this)}
