...
class Github extends Component {
  ...
  render() {
    ...
    if (this.state.isOrg) {
      ...
      child = <GithubRepo user={this.props.user || this.props.org} repo={this.props.repo} type={type} />
    }
    ...
    if (type === 'button') {
      ...
      child = (
        <div>
          ...
          <a
            className='rsg-inline-link'
            onMouseEnter={this.tooltipMouseEnter.bind(this)}
            onMouseLeave={this.tooltipMouseLeave.bind(this)}
            ref={el => this.refLinkButton = el}
            style={{ display: 'inline' }}
          >
            {this.props.children || 'Github'}
          </a>
        </div>
      );
    } else {
    ...
    return (
      <div id={this.props.id} className="rsg-github" style={this.props.style}>
        {child}
      </div>
    );
  }
