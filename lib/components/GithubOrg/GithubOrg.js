...
class GithubOrg extends Component {
  ...
  render() {
    ...
    let classes = "rsg-github-wrapper rsg-github-org";
        ...
        <div className="rsg-counters">
          <div className="rsg-item">
            ...
            <div className="rsg-description">
              ...
              <div className="rsg-label">{ this.state.org.public_repos > 1 ? "Repos" : "Repo" }</div>
            </div>
          </div>
          <div className="rsg-item">
            ...
            <div className="rsg-description">
              ...
              <div className="rsg-label">{ this.state.org.public_gists > 1 ? "Gists" : "Gist" }</div>
            </div>
          </div>
        </div>
